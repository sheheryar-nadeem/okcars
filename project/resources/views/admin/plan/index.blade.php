							...
							<div class="row">
								<div class="col-lg-12">
										...
										<ul class="links">
											...
											<li>
												<a href="{{ route('admin-plan-index') }}">Plan Management</a>
											</li>
										</ul>
								</div>
							</div>
...
<div class="modal fade" id="confirm-delete" tabindex="-1" role="dialog" aria-labelledby="modal1" aria-hidden="true">
  <div class="modal-dialog">
	...
	<div class="modal-header d-block text-center">
      ...
      <!-- Modal body -->
      <div class="modal-body">
            <p class="text-center">You are about to delete this Plan. Everything under this plan will be deleted.</p>
...
{{-- DATA TABLE --}}
    ...
    <script type="text/javascript">
        ...
        $(".btn-area").append('<div class="col-sm-4 table-contents">'+
        	'<a class="add-btn" data-href="{{route('admin-plan-create')}}" id="add-data" data-toggle="modal" data-target="#modal1">'+
