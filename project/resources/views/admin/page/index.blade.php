...
@section('content')
					<input type="hidden" id="headerdata" value="PAGE">
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        $(".btn-area").append('<div class="col-sm-4 text-right">'+
        	'<a class="add-btn" data-href="{{route('admin-page-create')}}" id="add-data" data-toggle="modal" data-target="#modal1">'+
