...
@section('content')
            ...
            <div class="content-area">
              <div class="mr-breadcrumb">
                <div class="row">
                  <div class="col-lg-12">
                      <h4 class="heading">Latest Cars </h4>
                      <ul class="links">
                        <li>
                        ...
                        <li>
                          <a href="{{ route('admin-ps-latest_cars') }}">Latest Cars </a>
                        </li>
                      </ul>
                  </div>
                </div>
                      ...
                      <form id="geniusform" action="{{ route('admin-ps-update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        @include('includes.admin.form-both')
                                    ...
                                    <div class="row">
                                      ...
                                      <div class="col-lg-7">
                                        <input type="text" class="input-field" name="latest_stxt" placeholder="Small Text" required="" value="{{$data->latest_stxt}}">
                                      </div>
                                    </div>
                                    ...
                                    <div class="row">
                                      ...
                                      <div class="col-lg-7">
                                        <input type="text" class="input-field" name="latest_btxt" placeholder="Bold Text" required="" value="{{$data->latest_btxt}}">
                                      </div>
                                    </div>
