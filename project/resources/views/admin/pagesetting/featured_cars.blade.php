                ...
                <div class="row">
                  <div class="col-lg-12">
                      ...
                      <ul class="links">
                        ...
                        <li>
                          <a href="{{ route('admin-ps-featured_cars') }}">Featured Cars </a>
                        </li>
                      </ul>
                  </div>
                </div>
                      ...
                      <form id="geniusform" action="{{ route('admin-ps-update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        @include('includes.admin.form-both')
                                    ...
                                    <div class="row">
                                      ...
                                      <div class="col-lg-7">
                                        <input type="text" class="input-field" name="featured_stxt" placeholder="Small Text" required="" value="{{$data->featured_stxt}}">
                                      </div>
                                    </div>
                                    ...
                                    <div class="row">
                                      ...
                                      <div class="col-lg-7">
                                        <input type="text" class="input-field" name="featured_btxt" placeholder="Bold Text" required="" value="{{$data->featured_btxt}}">
                                      </div>
                                    </div>
