...
@section('content')
					...
					<div class="content-area">
						<div class="mr-breadcrumb">
							<div class="row">
								<div class="col-lg-12">
										<h4 class="heading">Body Types</h4>
										<ul class="links">
											<li>
											...
											<li>
												<a href="{{ route('admin-body-index') }}">Body Type Management</a>
											</li>
										</ul>
								</div>
							</div>
...
{{-- DATA TABLE --}}
    ...
    <script type="text/javascript">
		...
		var table = $('#geniustable').DataTable({
               ...
               processing: true,
               serverSide: true,
               ajax: '{{ route('admin-body-datatables') }}',
               columns: [
                  { data: 'name', name: 'name' },
        ...
        $(".btn-area").append('<div class="col-sm-4 table-contents">'+
        	'<a class="add-btn" data-href="{{route('admin-body-create')}}" id="add-data" data-toggle="modal" data-target="#modal1">'+
          '<i class="fas fa-plus"></i> Add New Body Type'+
          '</a>'+
          '</div>');
      });
