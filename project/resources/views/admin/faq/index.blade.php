								...
								<div class="heading-area">
	                                ...
	                                <div class="action-list">
	                                    <select class="process select droplinks {{ $gs->is_faq == 1 ? 'drop-success' : 'drop-danger' }}">
	                                      <option data-val="1" value="{{route('admin-isfaq',1)}}" {{ $gs->is_faq == 1 ? 'selected' : '' }}>Active</option>
	                                      <option data-val="0" value="{{route('admin-isfaq',0)}}" {{ $gs->is_faq == 0 ? 'selected' : '' }}>Deactive</option>
	                                    </select>
	                                  </div>
								</div>
...
<div class="modal fade" id="confirm-delete">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <!-- Modal body -->
      <div class="modal-body">
            <p class="text-center">You are about to delete this Faq.</p>
