                ...
                <div class="row">
                  <div class="col-lg-12">
                    ...
                    <ul class="links">
                      ...
                      <li>
                        <a href="{{ route('admin-gs-contents') }}">Payment Informations</a>
                      </li>
                    </ul>
                  </div>
                </div>
                    ...
                    <div class="product-description">
                      <div class="body-area">
                        ...
                        <div class="row justify-content-center">
                          <div class="col-lg-3">
                            <div class="left-area">
                                <h4 class="heading">Paypal Client ID *
                                  </h4>
                            </div>
                          </div>
                          <div class="col-lg-6">
                            <input type="text" class="input-field" placeholder="Paypal Client ID" name="pb" value="{{ $gs->pb }}" required="">
                          </div>
                        </div>
                        ...
                        <div class="row justify-content-center">
                          <div class="col-lg-3">
                            <div class="left-area">
                                <h4 class="heading">Stripe Secret Key *
                                  </h4>
                            </div>
                          </div>
                          <div class="col-lg-6">
                            <input type="text" class="input-field" placeholder="Stripe Secret Key" name="ss" value="{{ $gs->ss }}" required="">
                          </div>
                        </div>
