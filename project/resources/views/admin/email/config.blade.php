                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-lg-6">
                                <div class="action-list">
                                    <select class="process email_is_type select droplinks {{ $gs->is_smtp == 1 ? 'drop-success' : 'drop-danger' }}">
                                      <option data-val="1" value="{{route('admin-gs-issmtp',1)}}" {{ $gs->is_smtp == 1 ? 'selected' : '' }}>Active</option>
                                      <option data-val="0" value="{{route('admin-gs-issmtp',0)}}" {{ $gs->is_smtp == 0 ? 'selected' : '' }}>Deactive</option>
                                    </select>
                                  </div>
                            </div>
                          </div>
