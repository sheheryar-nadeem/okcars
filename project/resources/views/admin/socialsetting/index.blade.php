...
<div class="content-area">
            ...
            <div class="gocover" style="background: url({{ asset('assets/images/spinner.gif') }}) no-repeat scroll center center rgba(45, 45, 45, 0.5);"></div>
              <form id="geniusform" class="form-horizontal" action="{{ route('admin-social-update') }}" method="POST">
              {{ csrf_field() }}
              ...
              @include('includes.admin.form-both')
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    <input class="form-control" name="instagram" id="instagram" placeholder="http://instagram.com/" type="text" value="{{$data ? $data->instagram : ''}}">
                  </div>
                  <div class="col-sm-3">
                    <label class="switch">
                      <input type="checkbox" name="i_status" value="1" {{$data ? $data->i_status==1?"checked":"" : ""}}>
                      <span class="slider round"></span>
                    </label>
                  </div>
                </div>
