...
@section('content')  
					<input type="hidden" id="headerdata" value="LANGUAGE">
								...
								<div class="heading-area">
	                                ...
	                                <div class="action-list">
	                                    <select class="process select droplinks {{ $gs->is_language == 1 ? 'drop-success' : 'drop-danger' }}">
	                                      <option data-val="1" value="{{route('admin-gs-islanguage',1)}}" {{ $gs->is_language == 1 ? 'selected' : '' }}>Active</option>
	                                      <option data-val="0" value="{{route('admin-gs-islanguage',0)}}" {{ $gs->is_language == 0 ? 'selected' : '' }}>Deactive</option>
	                                    </select>
	                                  </div>
								</div>  
