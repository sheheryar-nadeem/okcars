                    ...
                    <div class="product-description">
                      ...
                      <form id="geniusformdata" action="{{route('admin-blog-update',$data->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="source" placeholder="Source" required="" value="{{$data->source}}">
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-7">
                              <div class="text-editor">
                                <textarea class="form-control" name="meta_description" placeholder="Meta Description" rows="5" cols="80">{{ $data->meta_description }}</textarea> 
                              </div>
                            </div>
                          </div>
                        </div>
